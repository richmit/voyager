...
| {{{c16(  g LBL A  )}}} |   =43,22, A= |                    n y z t |           | {{{WBT(A)}}} *=SLn=* -- Shift Left n bits                                 |
| {{{c16(  GSB 2    )}}} |         =21= |               2  2^x y z ? |           |                                                                           |
| {{{c16(  ×        )}}} |         =20= |               SLn(x) z ? ? |           | Ret                                                                       |
| {{{c16(  g RTN    )}}} |      =43 21= |                            |           |                                                                           |
| {{{c16(  g LBL B  )}}} |   =43,22, b= |                    n y z t |           | {{{WBT(B)}}} *=SRn=* -- Shift Right n bits                                |
| {{{c16(  GSB 2    )}}} |      =21  2= |                  2^x y z ? |           |                                                                           |
| {{{c16(  ÷        )}}} |         =10= |               SRn(x) z ? ? |           | Ret                                                                       |
| {{{c16(  g RTN    )}}} |      =43 21= |                            |           |                                                                           |
| {{{c16(  g LBL C  )}}} |   =43,22, C= |                    x y z t |           | {{{WBT(C)}}} *=CTZ=* -- Count Trailing Zeros                              |
| {{{c16(  g X=0    )}}} |      =43 40= |                    x y z t |           |                                                                           |
| {{{c16(  ÷        )}}} |      =10  0= |                      y z t |           | Ret when x=0                                                              |
| {{{c16(  GSB 1    )}}} |      =21  1= |                 LSSB y ? ? |           |                                                                           |
| {{{c16(  GSB E    )}}} |      =21  E= |               CTZ(x) y ? ? |           | Ret when x≠0                                                              |
| {{{c16(  g RTN    )}}} |      =43 21= |                            |           |                                                                           |
| {{{c16(  g LBL E  )}}} |   =43,22, E= |                    x y z t |           | {{{WBT(E)}}} *=iLog=* -- Integer logarithm: $\mathrm{floor}(\log_2(x))$   |
...
| {{{c16(  g RTN    )}}} |      =43 21= |                            |           |                                                                           |
| {{{c16(  g LBL F  )}}} |   =43,22, F= |                    x y z t |           | {{{WBT(F)}}} *=WSIZE=* -- Recall the WSIZE value                          |
| {{{c16(  1        )}}} |       =1  1= |                      x y z |           |                                                                           |
...
| {{{c16(  g RTN    )}}} |      =43 21= |                            |           |                                                                           |
| {{{c16(  g LBL 2  )}}} |   =43,22, 2= |                    x y z t |           | {{{WBT(2)}}} *=2^x=* -- Compute $2^x$                                     |
| {{{c16(  1        )}}} |          =1= |                    1 x y z |           |                                                                           |
| {{{c16(  X≷Y      )}}} |         =34= |                    x 1 y z |           |                                                                           |
| {{{c16(  f RLn    )}}} |         =42= |               e  2^X y z z |           | Ret                                                                       |
| {{{c16(  g RTN    )}}} |      =43 21= |                            |           |                                                                           |
| {{{c16(  g LBL 1  )}}} |   =43,22, 1= |                    x y z t |           | {{{WBT(1)}}} *=LSSB=* -- Clear all but least significant set bit          |
| {{{c16(  g X=0    )}}} |      =43 40= |                    x y z t |           |                                                                           |
