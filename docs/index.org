...
this page.  Note that some of my key liable choices don't look exactly like what is on the physical calculator.  For example I use "E↑X" instead of $e^x$.  In
...
| {{{WFBT(Y↑X)}}} | {{{WFBT(1/X)}}} | {{{WFBT(%T)}}} | {{{WFBT(Δ%)}}}  |  {{{WFBT(%)}}}  |  {{{WFBT(EEX)}}}  | {{{WFBT(4)}}} | {{{WFBT(5)}}} | {{{WFBT(6)}}}  | {{{WFBT(×)}}} |
...
|    {{{YFBT(OFF)}}}     |    {{{YFBT( )}}}     |    {{{YFBT( )}}}     |    {{{YFBT(FRAC)}}}     |  {{{YFBT(USER)}}}   | {{{YFBT(CLR_PREFIX)}}} | {{{YFBT(FIX_0)}}} |   {{{RFBT(∅)}}}   |   {{{RFBT(∅)}}}   | {{{RFBT(∅)}}} |
#+BEGIN_CENTER
...
| {{{BFBT(√X)}}}  | {{{BFBT(E↑X)}}} | {{{BFBT(LN)}}}  | {{{BFBT(FRAC)}}} | {{{BFBT(INTG)}}} | {{{BFBT(ΔDAYS)}}} | {{{BFBT(D.MY)}}} | {{{BFBT(M.DY)}}} | {{{BFBT(x̄w)}}}  | {{{BFBT(X↑2)}}}  |
