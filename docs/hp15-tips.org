...
If the calculator is in complex mode (Flag {{{flg(9)}}} set):
...
If the calculator is not in complex mode (Flag {{{flg(9)}}} clear):
...
Like the [[#triHypAngle][previous item]], this one also illustrates the different behavior of {{{c15(→R)}}} and {{{c15(→P)}}} when complex mode (flag {{{flg(9)}}} set)
...
| {{{c15(68 g ŷ\,r)}}}        | The celsius value is on the stack at {{{stk(X)}}} |
| {{{c15(70 g ŷ\,r)}}}        | The celsius value is on the stack at {{{stk(X)}}} |
| {{{c15(72 g ŷ\,r)}}}        | The celsius value is on the stack at {{{stk(X)}}} |
