...
- Program end conditions
  ...
  - The system solution, $X$, will be in {{{c15(C)}}} -- note this might not be a valid solution if $A$ is singular (i.e. $\vert A\vert=0$).
  ...
  - The screen is always flashing after this program runs.  I don't know why.
...
#+BEGIN_CENTER
=LIN_SLV= -- Solve $AX=B$ with solution in C, LU in E, and ABS(DET) on stack
#+END_CENTER
#+ATTR_HTML: :align center :cellpadding 1em
| <l>                          |         <r> |                        <r> |    <c>    | <l>                            |
| *Keystrokes* {{{SPC}}}       | *Key Codes* | {{{SPC}}} *Stack Contents* | {{{SPC}}} | *Comments*                     |
...
| {{{c15(g ABS            )}}} |     =43 16= |             ABS(DET) x y z |           |                                |
| {{{c15(1                )}}} |         =1= |             1 ABS(DET) x y |           |                                |
| {{{c15(EEX              )}}} |        =26= |             1 ABS(DET) x y |           |                                |
| {{{c15(7                )}}} |         =7= |           1e7 ABS(DET) x y |           |                                |
| {{{c15(CHS              )}}} |        =16= |           eps ABS(DET) x y |           |                                |
| {{{c15(x≷y              )}}} |        =34= |          ABS(DET) eps  x y |           |                                |
| {{{c15(g TEST 8         )}}} |   =43,30 8= |          ABS(DET) eps  x y |           | x>y                            |
| {{{c15(g RTN            )}}} |     =43 32= |          ABS(DET) eps  x y |           |                                |
| {{{c15(RCL MATRIX B     )}}} |  =45,16,12= |               B ABS(DET) x |           |                                |
| {{{c15(RCL MATRIX E     )}}} |  =45,16,15= |           E B ABS(DET) x y |           | E has LU from {{{c15(LBL 9)}}} |
| {{{c15(f RESULT C       )}}} |  =42,26,13= |             E B ABS(DET) x |           |                                |
| {{{c15(÷                )}}} |        =10= |             C ABS(DET) x x |           |                                |
| {{{c15(f RESULT E       )}}} |  =42,26,15= |             C ABS(DET) x x |           | Set result back to E           |
| {{{c15(x≷y              )}}} |        =34= |             ABS(DET) C x x |           |                                |
| {{{c15(f MATRIX 1       )}}} |  =42,16, 1= |             ABS(DET) C x x |           |                                |
| {{{c15(g RTN            )}}} |     =43 32= |             ABS(DET) C x x |           | Ret when A is singular         |
...
This program simply computes the determinant of the {{{c15(A)}}} matrix putting it in stack position X, and places the LU factorization in the {{{c15(E)}}}
matrix.  I preform this operation frequently, so the 7 keystrokes it saves me adds up. =:)=
...
#+BEGIN_CENTER
=DET_A= -- Determinant of A with LU in E
#+END_CENTER
#+ATTR_HTML: :align center :cellpadding 1em
| <l>                          |         <r> |                        <r> |    <c>    | <l>        |
| *Keystrokes* {{{SPC}}}       | *Key Codes* | {{{SPC}}} *Stack Contents* | {{{SPC}}} | *Comments* |
...
|      =8=       | [[#matSlv][Solve Linear System]]       |                                                        |      =.8=      | Unused                   |
|      =9=       | [[#matDet][Determinant]]               |                                                        |      =.9=      | Unused                   |
|----------------+----------------------------------------+--------------------------------------------------------+----------------+--------------------------|
|      =A=       | Unused                                 |                                                        |                |                          |
|      =B=       | Unused                                 |                                                        |                |                          |
