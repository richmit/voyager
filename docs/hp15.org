...
These programs don't do anything the HP-15C can't already do.  They simply reduce the number of keystrokes required.
...
*** Stack Diagrams
:PROPERTIES:
:CUSTOM_ID: matFillStk
:END:

#+BEGIN_CENTER
*=FILL_MAT=* -- Store Complex Number
#+END_CENTER
#+ATTR_HTML: :align center :cellpadding 3em
| <c>  | <l>      | <l>     |
|      | *Before* | *After* |
...
| <l>                          |         <r> |    <c>    |              <r> |    <c>    | <l>                              |
| *Keystrokes* {{{SPC}}}       | *Key Codes* | {{{SPC}}} | *Stack Contents* | {{{SPC}}} | *Comments*                       |
| {{{c15(  f LBL 7        )}}} |  =42,21, 7= |           |       n m Aor0 t |           |                                  |
| {{{c15(  RCL MATRIX A   )}}} |  =45,16,11= |           |       A n m Aor0 |           |                                  |
| {{{c15(  STO I          )}}} |     =44 25= |           |       A n m Aor0 |           |                                  |
| {{{c15(  g R↑           )}}} |     =43 33= |           |       Aor0 A n m |           |                                  |
| {{{c15(  g TEST 0       )}}} |  =43,30, 0= |           |       Aor0 A n m |           |                                  |
| {{{c15(  STO I          )}}} |     =44 25= |           |          A A n m |           | Sto given matrix descriptor in I |
| {{{c15(  R↓             )}}} |        =33= |           |       A n m Aor0 |           |                                  |
| {{{c15(  R↓             )}}} |        =33= |           |       n m Aor0 A |           |                                  |
| {{{c15(  f DIM I        )}}} |  =42,23,25= |           |       n m Aor0 A |           | Dim given matrix                 |
| {{{c15(  f MATRIX 1     )}}} |  =42,16, 1= |           |       n m Aor0 A |           | Set R0 & R1 to 1                 |
| {{{c15(  LBL .2         )}}} |  =42,21,.2= |           |       n m Aor0 A |           |                                  |
| {{{c15(  RCL 0          )}}} |     =45  0= |           |       i n m Aor0 |           |                                  |
| {{{c15(  RCL 1          )}}} |     =45  1= |           |          j i n m |           |                                  |
| {{{c15(  1              )}}} |         =1= |           |          1 j i n |           |                                  |
| {{{c15(  0              )}}} |         =0= |           |         10 j i n |           |                                  |
| {{{c15(  ÷              )}}} |        =10= |           |       j/10 i n n |           |                                  |
| {{{c15(  +              )}}} |        =40= |           |     j/10+i n n n |           |                                  |
| {{{c15(  R/S            )}}} |        =31= |           |     j/10+i n n n |           |                                  |
| {{{c15(  f USER         )}}} |           - |           |     j/10+i n n n |           | Enter USER mode                  |
| {{{c15(  STO (i)        )}}} | =u   44 24= |           |     j/10+i n n n |           |                                  |
| {{{c15(  f USER         )}}} |           - |           |     j/10+i n n n |           | Exit USER mode                   |
| {{{c15(  GTO .2         )}}} |     =22 .2= |           |     j/10+i n n n |           |                                  |
| {{{c15(  RCL I          )}}} |     =45 25= |           |     A j/10+i n n |           | Recall filled matrix to stack    |
| {{{c15(  g RTN          )}}} |     =43 32= |           |     A j/10+i n n |           |                                  |
...
- Program end conditions
  - Both {{{c15(A)}}} & {{{c15(B)}}} are left unchanged!
  - The LU factorization of $A$ will in {{{c15(E)}}}
  - The system solution, $X$, will be in {{{c15(C)}}} -- note this might not be a valid solution if $A$ is singular so check $\vert A\vert$
  - $\vert A\vert$ will be in stack position X
  - The matrix descriptor for {{{c15(C)}}} will be in stack position Y.
  - Both =R0= & =R1= will contain 1 in expectation {{{c15(USER)}}} mode will be used to visit the elements of {{{c15(C)}}} and/or {{{c15(E)}}}.
  - Matrix {{{c15(E)}}} will be selected as the {{{c15(RESULT)}}} matrix.
  - The screen is always flashing after this program runs on the HP-15CE.  I don't know why.
...
| {{{c15(GSB 9            )}}} |      =32 9= |           |        DET x y z |           |                                |
| {{{c15(RCL MATRIX B     )}}} |  =45,16,12= |           |       B DET(A) x |           |                                |
| {{{c15(RCL MATRIX E     )}}} |  =45,16,15= |           |     E B DET(A) x |           | E has LU from {{{c15(LBL 9)}}} |
| {{{c15(f RESULT C       )}}} |  =42,26,13= |           |     E B DET(A) x |           |                                |
| {{{c15(÷                )}}} |        =10= |           |     C DET(A) x x |           |                                |
| {{{c15(f RESULT E       )}}} |  =42,26,15= |           |     C DET(A) x x |           | Set result back to E           |
| {{{c15(x≷y              )}}} |        =34= |           |     DET(A) C x x |           |                                |
| {{{c15(f MATRIX 1       )}}} |  =42,16, 1= |           |     DET(A) C x x |           |                                |
| {{{c15(g RTN            )}}} |     =43 32= |           |     DET(A) C x x |           | Ret when A is singular         |
...
This program simply computes the determinant of the {{{c15(A)}}} matrix.  The determinant is left in stack position X, and the LU factorization is stored in the {{{c15(E)}}}
matrix.  Note the {{{c15(RESULT)}}} matrix will be set as {{{c15(E)}}}.  I preform this operation frequently, so the 7 keystrokes it saves me adds up. =:)=
...
| {{{c15(RCL MATRIX A     )}}} |    =45,16,11= |           |          A x y z |           |            |
| {{{c15(f MATRIX 9       )}}} |    =42,16, 9= |           |     DET(A) x y z |           |            |
| {{{c15(g RTN            )}}} |       =43 32= |           |     DET(A) x y z |           |            |
...
/*WARNING*/: This program is memory hungry in that it stores the LU factorization of $\tilde{A}$ in {{{c15(E)}}} and the solution in {{{c15(C)}}}.  On an
original HP-15C this is hard to fit even for a 2x2 system.  On the HP-15CE or the DM-15L things are better especially when using a large memory setting.

*** Usage
:PROPERTIES:
:CUSTOM_ID: cmatSlvUsage
:END:

This program solves the system $AX=B$ for $X$.  $A$ & $B$ are complex matrices in =C= format.
...
- Program end conditions
  - Both {{{c15(A)}}} & {{{c15(B)}}} are left unchanged!
  - The LU factorization of $\tilde{A}$ will in {{{c15(E)}}}
  - The system solution, $X$, will be in {{{c15(C)}}} -- note this might not be a valid solution if $A$ is singular so check $\mathrm{abs}(\vert A\vert)$
  - $\mathrm{abs}(\vert A\vert)$ will be in stack position X
  - The matrix descriptor for {{{c15(C)}}} will be in stack position Y.
  - Both =R0= & =R1= will contain 1 in expectation {{{c15(USER)}}} mode will be used to visit the elements of {{{c15(C)}}} and/or {{{c15(E)}}}.
  - Matrix {{{c15(E)}}} will be selected as the {{{c15(RESULT)}}} matrix.
  - The screen is always flashing after this program runs on the HP-15CE.  I don't know why.
...
- Internal Labels:
  - 5 Program label ({{{c15(5)}}} is right under {{{c15(8)}}} -- the label used for solving real complex systems)
- External Labels:
  - 8
- Registers:
  - None
...
#+BEGIN_CENTER
=CLIN_SLV= --  -- Solve $AX=B$ where $A$ and $B$ are complex matrices in =C= form
#+END_CENTER
#+ATTR_HTML: :align center :cellpadding 1em
| <l>                            |         <r> |    <c>    |                 <r> |    <c>    | <l>        |
| *Keystrokes* {{{SPC}}}         | *Key Codes* | {{{SPC}}} |    *Stack Contents* | {{{SPC}}} | *Comments* |
| {{{c15(  f LBL 5          )}}} |  =42,21, 5= |           |             x y z t |           |            |
| {{{c15(  GSB 6            )}}} |     =32  6= |           |             x y z t |           |            |
| {{{c15(  RCL MATRIX B     )}}} |  =45,16,12= |           |  Bc ABS(DET(A)) x y |           |            |
| {{{c15(  f Py\,x          )}}} |     =42 40= |           |  Bp ABS(DET(A)) x y |           |            |
| {{{c15(  RCL MATRIX E     )}}} |  =45,16,15= |           | E~ Bp ABS(DET(A)) x |           |            |
| {{{c15(  f RESULT C       )}}} |  =42,26,13= |           | E~ Bp ABS(DET(A)) x |           |            |
| {{{c15(  ÷                )}}} |        =10= |           |  Cp ABS(DET(A)) x x |           |            |
| {{{c15(  g Cy\,x          )}}} |     =43 40= |           |  Cc ABS(DET(A)) x x |           |            |
| {{{c15(  f RESULT E       )}}} |  =42,26,15= |           |  Cc ABS(DET(A)) x x |           |            |
| {{{c15(  x≷y              )}}} |        =34= |           |  ABS(DET(A)) Cc x x |           |            |
| {{{c15(  f MATRIX 1       )}}} |  =42,16, 1= |           |  ABS(DET(A)) Cc x x |           |            |
| {{{c15(  RCL MATRIX B     )}}} |  =45,16,12= |           | Bp ABS(DET(A)) Cc x |           |            |
| {{{c15(  g Cy\,x          )}}} |     =43 40= |           | Bc ABS(DET(A)) Cc x |           |            |
| {{{c15(  R↓               )}}} |        =33= |           | ABS(DET(A)) Cc x Bc |           |            |
| {{{c15(  g RTN            )}}} |     =43 32= |           |  ABS(DET(A)) Cc x x |           |            |
...
*** Usage
:PROPERTIES:
:CUSTOM_ID: cmatDetUsage
:END:

This program simply computes the Magnitude (absolute value) of the determinant of the complex matrix in {{{c15(A)}}} (in =C= format).  The magnitude of the
determinant is left in stack position X, and the LU factorization of $\tilde{A}$ is stored in the {{{c15(E)}}} matrix.  The matrix in {{{c15(A)}}} is left
unchanged. Note the {{{c15(RESULT)}}} matrix will be set as {{{c15(E)}}}.  

*** Resources Used
:PROPERTIES:
:CUSTOM_ID: cmatDetRes
:END:

- Internal Labels:
  - 8 Program label ({{{c15(6)}}} is right under {{{c15(9)}}} -- the label used for real determinant)
- External Labels:
  - N/A
- Registers:
  - N/A
...
*** Program Listing
:PROPERTIES:
:CUSTOM_ID: cmatDetCode
:END:

#+BEGIN_CENTER
=CDET_A= -- Magnutude of Determinant of Complex Matrix A
#+END_CENTER
#+ATTR_HTML: :align center :cellpadding 1em
| <l>                         |         <r> |    <c>    |                   <r> |    <c>    | <l>                          |
| *Keystrokes* {{{SPC}}}      | *Key Codes* | {{{SPC}}} |      *Stack Contents* | {{{SPC}}} | *Comments*                   |
| {{{c15(  f LBL 6       )}}} |  =42,21, 6= |           |               x y z t |           |                              |
| {{{c15(  f RESULT E    )}}} |  =42,26,15= |           |               x y z t |           |                              |
| {{{c15(  RCL MATRIX A  )}}} |  =45,16,11= |           |              Ac x y z |           |                              |
| {{{c15(  f Py\,x       )}}} |     =42 40= |           |              Ap x y z |           |                              |
| {{{c15(  f MATRIX 2    )}}} |  =42,16, 2= |           |              A~ x y z |           |                              |
| {{{c15(  f RESULT E    )}}} |  =42,26,15= |           |              A~ x y z |           |                              |
| {{{c15(  f MATRIX 9    )}}} |  =42,16, 9= |           | SQ(ABS(DET(A))) x y z |           |                              |
| {{{c15(  g ABS         )}}} |     =43 16= |           | SQ(ABS(DET(A))) x y z |           | If roundoff made it negative |
| {{{c15(  √x            )}}} |        =11= |           |     ABS(DET(A)) x y z |           |                              |
| {{{c15(  RCL MATRIX A  )}}} |  =45,16,11= |           |    A~ ABS(DET(A)) x y |           | Restore A to Ac form         |
| {{{c15(  f MATRIX 3    )}}} |  =42,16, 3= |           |    Ap ABS(DET(A)) x y |           |                              |
| {{{c15(  g Cy\,x       )}}} |     =43 40= |           |    Ac ABS(DET(A)) x y |           |                              |
...
|      =2=       | Solver/Integrator                         |                                                        |      =.2=      | Used in {{{c15(LBL 7)}}} |
|      =3=       | Solver/Integrator                         |                                                        |      =.3=      | Unused                   |
|      =4=       | Unused                                    |                                                        |      =.4=      | Unused                   |
|      =5=       | [[#cmatSlv][Solve Complex Linear System]] |                                                        |      =.5=      | Unused                   |
|      =6=       | [[#cmatDet][Complex Determinant]]         |                                                        |      =.6=      | Unused                   |
|      =7=       | [[#matFill][Fill A Matrix]]               |                                                        |      =.7=      | Unused                   |
|      =8=       | [[#matSlv][Solve Real  Linear System]]    |                                                        |      =.8=      | Unused                   |
|      =9=       | [[#matDet][Real Determinant]]             |                                                        |      =.9=      | Unused                   |
|----------------+-------------------------------------------+--------------------------------------------------------+----------------+--------------------------|
|      =A=       | Unused                                    |                                                        |                |                          |
|      =B=       | Unused                                    |                                                        |                |                          |
...
* Extract Complex Number from =C= format matrix                    :noexport:

This is in devleopment...

- 
  - Matrix descripter in stack position X
  - Array index in =R0= & =R1=

=CPLX_ELT= -- Extract Complex Number from =C= format matrix
#+END_CENTER
#+ATTR_HTML: :align center :cellpadding 1em
| <l>                    |         <r> |    <c>    |              <r> |    <c>    | <l>           |
| *Keystrokes* {{{SPC}}} | *Key Codes* | {{{SPC}}} | *Stack Contents* | {{{SPC}}} | *Comments*    |
| {{{c15(  f LBL 4 )}}}  |  =42,21, 4= |           |          M y z t |           |               |
| {{{c15(  STO I   )}}}  |     =44 25= |           |          M y z t |           |               |
| {{{c15(  g CLx   )}}}  |     =43 35= |           |          0 y z t |           | Disable stack |
| {{{c15(  RCL (i) )}}}  |     =45 24= |           |         Cr y z t |           |               |
| {{{c15(  f ISG 1 )}}}  |   =42,6, 1= |           |         Cr y z t |           |               |
| {{{c15(  g CLx   )}}}  |     =43 35= |           |         Cr y z t |           | NOP           |
| {{{c15(  f Re≷Im )}}}  |     =42 30= |           |        ~Cr y z t |           |               |
| {{{c15(  g CLx   )}}}  |     =43 35= |           |        ~Cr y z t |           | Disable stack |
| {{{c15(  RCL (i) )}}}  |     =45 24= |           |         ~C y z t |           |               |
| {{{c15(  f Re≷Im )}}}  |     =42 30= |           |          C y z t |           | Ret           |
| {{{c15(  g RTN   )}}}  |     =43 32= |           |          C y z t |           |               |
